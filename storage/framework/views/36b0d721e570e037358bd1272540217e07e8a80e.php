<div class="box-2fr1fr">
          ...
          <?php if($elements[0]->project_image_id): ?>
            <a href="<?php echo e(route('page.projects')); ?>/<?php echo AppHelper::getSlug($elements[0]->projectimage->project); ?>">
              <figure>
                ...
                <img src="<?php echo ImageHelper::get($elements[0]->projectimage->name, 'lg'); ?>" 
                  height="616" 
                  width="900" 
  ...
  </div><?php /**PATH /Users/marceli.to/Jamon.digital/Webroot/strut.ch/resources/views/web/partials/grids/home/2fr1fr.blade.php ENDPATH**/ ?>