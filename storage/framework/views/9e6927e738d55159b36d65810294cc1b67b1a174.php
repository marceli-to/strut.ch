<div class="box-1fr2fr">
          ...
          <?php if($elements[1]->project_image_id): ?>
            <a href="<?php echo e(route('page.projects')); ?>/<?php echo AppHelper::getSlug($elements[1]->projectimage->project); ?>">
              <figure>
                ...
                <img src="<?php echo ImageHelper::get($elements[1]->projectimage->name, 'lg'); ?>" 
                  height="616" 
                  width="900" 
  ...
  </div><?php /**PATH /Users/marceli.to/Jamon.digital/Webroot/strut.ch/resources/views/web/partials/grids/home/1fr2fr.blade.php ENDPATH**/ ?>