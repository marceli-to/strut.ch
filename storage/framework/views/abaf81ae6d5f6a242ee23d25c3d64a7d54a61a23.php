<div class="grid-2x1fr">
  ...
  <?php if(isset($elements[2])): ?>
    <div class="span">
      <a href="<?php echo ImageHelper::get($elements[2]->image->name, 'lg'); ?>" data-fancybox="gallery" data-caption="<?php echo e($elements[2]->image->caption); ?>">
        <img src="<?php echo ImageHelper::get($elements[2]->image->name, 'lg'); ?>"
          width="687"
          height="940"
  ...
  <?php endif; ?>
</div><?php /**PATH /Users/marceli.to/Jamon.digital/Webroot/strut.ch/resources/views/web/partials/grids/projects/1fr_stacked1fr.blade.php ENDPATH**/ ?>