            ...
            <div class="grid-1fr">
                <div class="span">
                    <div class="grid-1fr-highlight">
                        <figure class="span" v-for="element in elements" :key="element.id">
                            <a href="javascript:;" class="btn-trash" @click.prevent="deletePostElement(element.id, element.postmedia.post.id)">Delete</a>
