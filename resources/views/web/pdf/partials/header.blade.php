...
@font-face {
    ...
    src: url('{{ url("/") }}/assets/css/fonts/basis-grotesque-regular-pro.ttf') format("truetype");
    font-weight: normal;
    font-style: normal; 
}
...
@font-face {
    ...
    src: url('{{ url("/") }}/assets/css/fonts/basis-grotesque-medium-pro.ttf') format("truetype");
    font-weight: normal;
    font-style: normal; 
}
...
<header>
    <img src="{{ asset('assets/img/pdf/logo-strut.svg') }}" class="logo" height="100" width="196">
</header>
