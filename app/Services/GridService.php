...
class GridService
{
    ...
    public function __construct(ProjectGridElement $projectGridElement, HomeGridElement $homeGridElement)
    {
    ...
    public function isGridImage($imageId)
    {
        ...
        $isGridProject  = $this->projectGridElement->where('project_image_id', '=', $imageId)->get()->first();
